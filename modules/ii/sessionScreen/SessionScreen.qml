            ...
            ColumnLayout { // Content column
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        ...
                        text: Translation.translate("Arrow keys to navigate, Enter to select\nEsc or click anywhere to cancel")
                    }
                }
                ...
                GridLayout {
                    ...
                    SessionActionButton {
                        ...
                        buttonIcon: "lock"
                        buttonText: Translation.translate("Lock")
                        onClicked: {
                            Session.lock();
                            sessionRoot.hide();
                        }
                    ...
                    SessionActionButton {
                        ...
                        buttonText: Translation.translate("Sleep")
                        onClicked: {
                            Session.suspend();
                            sessionRoot.hide();
                        }
                    ...
                    SessionActionButton {
                        id: sessionLogout
                        buttonIcon: "logout"
                        buttonText: Translation.translate("Logout")
                        onClicked: {
                            Session.logout();
                            sessionRoot.hide();
                        }
                    ...
                    SessionActionButton {
                        ...
                        buttonText: Translation.translate("Task Manager")
                        onClicked: {
                    ...
                    SessionActionButton {
                        ...
                        buttonText: Translation.translate("Hibernate")
                        onClicked: {
                            Session.hibernate();
                            sessionRoot.hide();
                        }
                    ...
                    SessionActionButton {
                        ...
                        buttonText: Translation.translate("Shutdown")
                        onClicked: {
                            Session.poweroff();
                            sessionRoot.hide();
                        }
                    ...
                    SessionActionButton {
                        ...
                        buttonText: Translation.translate("Reboot")
                        onClicked: {
                            Session.reboot();
                            sessionRoot.hide();
                        }
                    ...
                    SessionActionButton {
                        ...
                        buttonText: Translation.translate("Reboot to firmware settings")
                        onClicked: {
            ...
            ColumnLayout {
                ...
                Loader {
                    ...
                    sourceComponent: DescriptionLabel {
                        text: Translation.translate("There might be a download in progress. Check your Downloads folder.")
                ...
                Loader {
                    ...
                    visible: active
                    sourceComponent: DescriptionLabel {
                        text: Translation.translate("Your package manager is running")
                        textColor: Appearance.m3colors.m3onErrorContainer
                        color: Appearance.m3colors.m3errorContainer
                    }
                }
