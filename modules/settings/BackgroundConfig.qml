...
ContentPage {
    ...
    ContentSection {
        icon: "sync_alt"
        title: Translation.translate("Parallax")

        ConfigSwitch {
            buttonIcon: "unfold_more_double"
            text: Translation.translate("Vertical")
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                text: Translation.translate("Depends on workspace")
            ...
            ConfigSwitch {
                ...
                text: Translation.translate("Depends on sidebars")
        ...
        ConfigSpinBox {
            icon: "loupe"
            text: Translation.translate("Preferred wallpaper zoom (%)")
    ...
    ContentSection {
        ...
        title: Translation.translate("Widget: Clock")
        ...
        ConfigRow {
            ...
            ConfigSelectionArray {
                ...
                options: [
                    {
                        displayName: Translation.translate("Draggable"),
                        icon: "drag_pan",
                        value: "free"
                    },
                    {
                        displayName: Translation.translate("Least busy"),
                        icon: "category",
                        value: "leastBusy"
                    },
                    {
                        displayName: Translation.translate("Most busy"),
                        icon: "shapes",
                        value: "mostBusy"
                    },
                ]
        ...
        ConfigSwitch {
            ...
            text: Translation.translate("Show only when locked")
        ...
        ConfigRow {
            ContentSubsection {
                ...
                title: Translation.translate("Clock style")
                Layout.fillWidth: true
                ConfigSelectionArray {
                    ...
                    options: [
                        {
                            displayName: Translation.translate("Digital"),
                            icon: "timer_10",
                            value: "digital"
                        },
                        {
                            displayName: Translation.translate("Cookie"),
                            icon: "cookie",
                            value: "cookie"
                        }
                    ]
            ...
            ContentSubsection {
                title: Translation.translate("Clock style (locked)")
                Layout.fillWidth: false
                ConfigSelectionArray {
        ...
        ContentSubsection {
            ...
            title: Translation.translate("Digital clock settings")
            tooltip: Translation.translate("Font width and roundness settings are only available for some fonts like Google Sans Flex")
            ...
            ConfigRow {
                ...
                ConfigSwitch {
                    ...
                    text: Translation.translate("Animate time change")
            ...
            ConfigRow {
                ...
                ConfigSwitch {
                    ...
                    text: Translation.translate("Show date")
                ...
                ConfigSwitch {
                    ...
                    text: Translation.translate("Use adaptive alignment")
                    ...
                    StyledToolTip {
                        text: Translation.translate("Aligns the date and quote to left, center or right depending on its position on the screen.")
                    }
                }
            }
            ...
            MaterialTextArea {
                Layout.fillWidth: true
                placeholderText: Translation.translate("Font family")
            ...
            ConfigSlider {
                text: Translation.translate("Font weight")
            ...
            ConfigSlider {
                text: Translation.translate("Font size")
            ...
            ConfigSlider {
                text: Translation.translate("Font width")
            ...
            ConfigSlider {
                text: Translation.translate("Font roundness")
        ...
        ContentSubsection {
            ...
            title: Translation.translate("Cookie clock settings")

            ConfigSwitch {
                buttonIcon: "wand_stars"
                text: Translation.translate("Auto styling with Gemini")
                ...
                StyledToolTip {
                    text: Translation.translate("Uses Gemini to categorize the wallpaper then picks a preset based on it.\nYou'll need to set Gemini API key on the left sidebar first.\nImages are downscaled for performance, but just to be safe,\ndo not select wallpapers with sensitive information.")
                }
            }

            ConfigSwitch {
                buttonIcon: "airwave"
                text: Translation.translate("Use old sine wave cookie implementation")
                ...
                StyledToolTip {
                    text: Translation.translate("Looks a bit softer and more consistent with different number of sides,\nbut has less impressive morphing")
                }
            }

            ConfigSpinBox {
                icon: "add_triangle"
                text: Translation.translate("Sides")
            ...
            ConfigSwitch {
                buttonIcon: "autoplay"
                text: Translation.translate("Constantly rotate")
                ...
                StyledToolTip {
                    text: Translation.translate("Makes the clock always rotate. This is extremely expensive\n(expect 50% usage on Intel UHD Graphics) and thus impractical.")
                }
            }
            ...
            ConfigRow {
                ...
                ConfigSwitch {
                    ...
                    text: Translation.translate("Hour marks")
                    ...
                    StyledToolTip {
                        text: Translation.translate("Can only be turned on using the 'Dots' or 'Full' dial style for aesthetic reasons")
                    }
                }
                ...
                ConfigSwitch {
                    ...
                    buttonIcon: "timer_10"
                    text: Translation.translate("Digits in the middle")
                    ...
                    StyledToolTip {
                        text: Translation.translate("Can't be turned on when using 'Numbers' dial style for aesthetic reasons")
                    }
                }
            }
        }
        ...
        ContentSubsection {
            visible: settingsClock.cookiePresent
            title: Translation.translate("Dial style")
            ConfigSelectionArray {
                ...
                options: [
                    ...
                    {
                        displayName: Translation.translate("Dots"),
                        icon: "graph_6",
                        value: "dots"
                    },
                    {
                        displayName: Translation.translate("Full"),
                        icon: "history_toggle_off",
                        value: "full"
                    },
                    {
                        displayName: Translation.translate("Numbers"),
                        icon: "counter_1",
                        value: "numbers"
                    }
                ]
        ...
        ContentSubsection {
            visible: settingsClock.cookiePresent
            title: Translation.translate("Hour hand")
            ConfigSelectionArray {
                ...
                options: [
                    ...
                    {
                        displayName: Translation.translate("Hollow"),
                        icon: "circle",
                        value: "hollow"
                    },
                    {
                        displayName: Translation.translate("Fill"),
                        icon: "eraser_size_5",
                        value: "fill"
                    },
                ]
        ...
        ContentSubsection {
            visible: settingsClock.cookiePresent
            title: Translation.translate("Minute hand")
            ...
            ConfigSelectionArray {
                ...
                options: [
                    ...
                    {
                        displayName: Translation.translate("Thin"),
                        icon: "line_end",
                        value: "thin"
                    },
                    {
                        displayName: Translation.translate("Medium"),
                        icon: "eraser_size_2",
                        value: "medium"
                    },
                    {
                        displayName: Translation.translate("Bold"),
                        icon: "eraser_size_4",
                        value: "bold"
                    },
                ]
        ...
        ContentSubsection {
            visible: settingsClock.cookiePresent
            title: Translation.translate("Second hand")
            ...
            ConfigSelectionArray {
                ...
                options: [
                    ...
                    {
                        displayName: Translation.translate("Line"),
                        icon: "line_end",
                        value: "line"
                    },
                    {
                        displayName: Translation.translate("Dot"),
                        icon: "adjust",
                        value: "dot"
                    },
                ]
        ...
        ContentSubsection {
            visible: settingsClock.cookiePresent
            title: Translation.translate("Date style")
            ...
            ConfigSelectionArray {
                ...
                options: [
                    ...
                    {
                        displayName: Translation.translate("Bubble"),
                        icon: "bubble_chart",
                        value: "bubble"
                    },
                    {
                        displayName: Translation.translate("Border"),
                        icon: "rotate_right",
                        value: "border"
                    },
                    {
        ...
        ContentSubsection {
            title: Translation.translate("Quote")
            ...
            MaterialTextArea {
                Layout.fillWidth: true
                placeholderText: Translation.translate("Quote")
    ...
    ContentSection {
        icon: "weather_mix"
        title: Translation.translate("Widget: Weather")
